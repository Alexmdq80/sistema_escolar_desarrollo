...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('domicilios', function (Blueprint $table) {
            ...
            $table->renameColumn('id_calle_entre1', 'calle_entre1_id');
            $table->renameColumn('id_calle_entre2', 'calle_entre2_id');
            ...
            $table->foreign('calle_entre1_id')
                  ->references('id')
                  ->on('calles')
                  ->onDelete('restrict');

            $table->foreign('calle_entre2_id')
                  ->references('id')
                  ->on('calles')
                  ->onDelete('restrict');
        });
    ...
    public function down(): void
    {
        Schema::table('domicilios', function (Blueprint $table) {
            ...
            $table->dropForeign(['calle_entre1_id']);
            $table->dropForeign(['calle_entre2_id']);
            ...
            $table->dropIndex('domicilios_calle_entre1_id_foreign');
            $table->dropIndex('domicilios_calle_entre2_id_foreign');
            ...
            $table->renameColumn('calle_entre1_id', 'id_calle_entre1');
            $table->renameColumn('calle_entre2_id', 'id_calle_entre2');
