...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('localidad_censal')) {
            Schema::create('localidad_censal', function (Blueprint $table) {
            $table->smallInteger('id')->unsigned()->primary();
            $table->string('id_georef', 8)->nullable();
            ...
            $table->tinyInteger('id_funcion_georef')->unsigned()->nullable();
            ...
            // $table->string('funcion', 30)->nullable();
    ...
    {
     //   Schema::dropIfExists('localidad_censal');
    }
};
