...
class GenerarHistorialUuid extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generar:historial-uuid';
     ...
     * @var string
     */
    protected $description = 'Genera un UUID para los registros de HistorialInscripcion con cierre_causa_id = 1.';
    ...
    public function handle()
    {
        ...
        //    donde la causa de cierre sea '1'.
        $registrosInfo = HistorialInfoInscripcion::where('cierre_causa_id', 1)->get();

        if ($registrosInfo->isEmpty()) {
            $this->info('No se encontraron registros con cierre_causa_id = 1. Finalizando.');
