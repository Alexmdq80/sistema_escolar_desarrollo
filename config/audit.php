...
return [
    ...
    */
    ...
    'drivers' => [
        ...
        'authentication' => [ // <-- ¡Este es tu nuevo driver!
            'table'     => 'authentication_audits', // <-- ¡El nombre de tu nueva tabla!
            'connection' => null, // Puedes especificar una conexión de DB diferente si lo necesitas, si no, déjalo en null
        ],
        // Puedes añadir más drivers si planeas separar otras auditorías en el futuro
],
